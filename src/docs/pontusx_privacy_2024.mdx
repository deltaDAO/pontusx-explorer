...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| local-settings                | Remember your settings.                                                                                                 | First-party local storage, stored persistently.                 |
| react-router-scroll-positions | Remember your scroll position on a page to return you to that position when you reload the page or navigate back to it. | First-party session storage deleted after you quit your browser. |
